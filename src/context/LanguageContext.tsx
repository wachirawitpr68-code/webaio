...
const translations: Record<Language, Record<string, string>> = {
  th: {
    ...
    'about.title': 'เกี่ยวกับ AIO LAB',
    'about.card1.title': 'งานวิจัยชั้นนำ',
    'about.card1.desc': 'ผลักดันขีดจำกัดของเทคโนโลยีด้วยระเบียบวิธีวิจัยและนวัตกรรมที่ทันสมัยระดับสากล',
    'about.card2.title': 'ทีมผู้เชี่ยวชาญ',
    'about.card2.desc': 'ศูนย์รวมนักวิจัย คณาจารย์ และนักศึกษาผู้มีวิสัยทัศน์แห่งมหาวิทยาลัยอุบลราชธานี',
    'about.card3.title': 'สร้างผลกระทบต่อสังคม',
    'about.card3.desc': 'เปลี่ยนการค้นพบทางวิชาการให้เป็นแอปพลิเคชันที่ใช้งานได้จริงและเป็นประโยชน์ต่อสังคม',
  ...
  en: {
    ...
    'about.title': 'About AIO LAB',
    'about.card1.title': 'Leading Research',
    'about.card1.desc': 'Pushing the boundaries of technology with modern, world-class research methodologies and innovations.',
    'about.card2.title': 'Expert Team',
    'about.card2.desc': 'A hub of visionary researchers, faculty, and students from Ubon Ratchathani University.',
    'about.card3.title': 'Social Impact',
    'about.card3.desc': 'Transforming academic discoveries into practical applications that benefit society.',
